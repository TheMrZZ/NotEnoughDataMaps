...
execute if entity @s[tag=loop_animator] run data modify entity @e[tag=can_be_animated,tag=current,limit=1] Pos set from entity @s ArmorItems[0].tag.InitialPos
